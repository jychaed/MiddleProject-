...
<body id="body">
    ...
    <div class="stu_wrap" style="min-height:auto">
        <!-- 기존 헤더 영역(삭제하세요.) -->
...
<section style="background:#fff;padding-top:30px;padding-bottom:20px;margin-top:0px;">
      <div class="stu_inner_wrap">
<div style="float:left;width:55%;">
	<div style="margin-top:0px;width:100%;overflow-x:hidden;padding-top:10px;">

			<img width="100%" src="https://d3b39vpyptsv01.cloudfront.net/0/0/155831987495262cETR5VwF.jpg">
			
	</div>
</div>
<div style="float:left;width:45%;padding-left:15px;padding-bottom:20px;padding-top:8px;">
	<div style="padding-left:40px;padding-right:40px;position:relative;padding-bottom:20px;border:1px solid #efefef;background:#f5f5f5;border-radius:20px">
		<div style="padding-top:20px;padding-bottom:0px;">
			 <div class="titArea" >


<h3 class="stu_title" style="font-size:13pt;font-weight:500;line-height:170%">상상속 유럽여행,  <font style="font-size:14pt"><br>현실로 만들어 보세요.</font></h3>
<p  style="margin-top:10px;font-size:11pt;font-weight:300;line-height:210%">

	<font style="font-weight:500">지도 위에서 다양한 유럽 도시들을 탐색하고 <br>
	교통편과 숙박일수를 추천 받으세요.<br/>
	친구를 초대해 함께 하거나 <br>모바일 앱에서 수정할 수 있습니다.
	</font>
		...
		<div style="margin-top:15px;padding-top:0px;margin-left:0px;margin-right:0px;padding-left:10px;padding-right:10px;">
			<div style="float:left;width:100%;position:relative;display:inline-block;margin-top:0px;vertical-align:middle">


				<a href="/common/login.asp" style="border-radius:30px;margin-right:5px;text-align:center;width:100%;text-decoration:none;font-weight:300;color:#fff;font-size:14pt;display:inline-block;padding:10px 20px;border: 1px solid #ee685a;color:#ee685a">플래너 시작하기</a>
			</div>
<!--
			<div style="float:left;width:50%;display:inline-block;margin-top:0px;margin-left:0px;vertical-align:middle ">
				<a href="/consulting/index.asp" style="border-radius:30px;margin-left:5px;text-align:center;width:100%;text-decoration:none;font-weight:300;color:#fff;font-size:14pt;display:inline-block;padding:10px 15px;border: 1px solid #3ad195;color:#3ad195" >맞춤여행 의뢰</a>
			</div>
-->
...
function showCustomSelector()
{
	$("#speech-bubble").hide();
	$("#speech-bubble2").show();
}
</script>
					<div id="speech-bubble" class="speech-bubble" style="display:none;margin-top:20px;margin-bottom:0px;height:50px;">	
	
						<div style="width:49%;vertical-align:middle;float:left">
							<a href="/planner/planner_rt.asp" style="margin-top:8px;margin-bottom:8px;margin-left:12px;margin-right:4px;center;text-decoration:none;font-weight:300;color:#fff;font-size:12pt;display:inline-block;padding-top:6px;padding-bottom:6px;width:90%;text-align:center;border:0px solid #fff;border-radius:2px">직접 만들기</a>

						</div><div style="width:50%;vertical-align:middle;float:left;">

							<a href="/stubbyx/step0.asp" style="margin-top:8px;margin-bottom:8px;padding-left:4px;margin-left:4px;margin-right:12;text-align:center;text-decoration:none;font-weight:300;color:#fff;font-size:12pt;display:inline-block;padding-top:6px;padding-bottom:6px;width:90%;text-align:center;border-left:1px solid #fff;border-radius:0px" >추천받아 만들기</a>
						</div>
						<div style="clear:both"></div>
...
<!--
					<div id="speech-bubble2" class="speech-bubble2" style="display:none;margin-top:20px;margin-bottom:20px;height:50px;">	
	
						<div style="width:39%;vertical-align:middle;float:left">
							<a href="/template/index.asp" style="margin-top:8px;margin-bottom:8px;margin-left:12px;margin-right:4px;center;text-decoration:none;font-weight:300;color:#fff;font-size:12pt;display:inline-block;padding-top:6px;padding-bottom:6px;width:90%;text-align:center;border:0px solid #fff;border-radius:2px" >셀프 맞춤여행</a>

						</div><div style="width:60%;vertical-align:middle;float:left;">

							<a href="/consulting/index.asp" style="margin-top:8px;margin-bottom:8px;padding-left:4px;margin-left:4px;margin-right:12;text-align:center;text-decoration:none;font-weight:300;color:#fff;font-size:12pt;display:inline-block;padding-top:6px;padding-bottom:6px;width:90%;text-align:center;border-left:1px solid #fff;border-radius:0px">전문가 의뢰</a>
						</div>
						<div style="clear:both"></div>
...
<div style="clear:both"></div>
       ...
       <section class="stu_swiper-section stu_recent-offer" style="padding-top:0px;margin-top:10px">
            <div class="stu_inner_wrap">
                <div class="titArea">
                    <h3 class="stu_title" style="font-weight:300">
			준비중인 여행자들의 플래너

			<!--<font style="font-size:10pt;font-weight:400">855,014개</font>-->
		</h3>
                </div>
                ...
                <div class="swiper-container stu_tagArea">
                    <ul class="swiper-wrapper">
                        <li class="swiper-slide">
                            <a href="javascript:getTrips('');" id="a_trips_" class="stu_tag stu_tag_on ico_theme">
                                최신
                            </a>
                        </li>

                        <li class="swiper-slide">
                            <a href="javascript:getTrips('7');" id="a_trips_7" class="stu_tag ico_theme">
                                아이들과
                            </a>
                        </li>
                        <li class="swiper-slide">
                            <a href="javascript:getTrips('3');" id="a_trips_3"  class="stu_tag ico_theme">
                            커플/신혼
                            </a>
                        </li>
                        ...
                        <li class="swiper-slide">
                            <a href="javascript:getTrips('8');" id="a_trips_8"  class="stu_tag ico_theme">
                                부모님과
                            </a>
                        </li>
                        <li class="swiper-slide">
                            <a href="javascript:getTrips('2');" id="a_trips_2"  class="stu_tag ico_theme">
                              남자혼자
                            </a>
                        </li>
                        <li class="swiper-slide">
                            <a href="javascript:getTrips('1');" id="a_trips_1"  class="stu_tag ico_theme">
                               여자혼자
                            </a>
                        </li>
                        <li class="swiper-slide">
                            <a href="javascript:getTrips('4');" id="a_trips_4"  class="stu_tag ico_theme">
                                여자끼리
                            </a>
                        </li>
                        <li class="swiper-slide">
                            <a href="javascript:getTrips('5');" id="a_trips_5"  class="stu_tag ico_theme">
                                남자끼리
                            </a>
                        </li>
                        <li class="swiper-slide">
                            <a href="javascript:getTrips('6');" id="a_trips_6"  class="stu_tag ico_theme">
                               남녀함께
                            </a>
                        </li>
...
function getTrips(tw)
{
	$("#div_trips").html('<div style="text-align:center;padding-top:30px;padding-bottom:30px;">로딩중...</div>');
		$("#a_trips_"+prv_tw).removeClass("stu_tag_on");

		$("#a_trips_"+tw).addClass("stu_tag_on");
		
	             $.ajax({
	             	url: '/api/planning/get_trips.asp?lang=&is_home=1&tripwith='+tw,
	               	dataType: 'json',
	...
	thtml+='<a href="javascript:showRouteMap(\''+item.trip_id+'\')">';

thtml+='<div style="float:left;width:24%;margin-right:1%;margin-bottom:20px;position:relative;">';
thtml+='<div style="padding-left:0px;padding-right:0px;">';
thtml+='<div class="card_myplan">';
thtml+='<div style="position:relative" >';

if(item.cost>0)
	planner_img=item.planner_img.replace('400x400','400x290');
else
	planner_img=item.planner_img;

thtml+='<img style="border:1px solid #efefef;border-top-right-radius:10px;border-top-left-radius:10px;"  width="100%" src="'+planner_img+'"   onerror="this.src=\'https://www.stubbyplanner.com/img_v9/img_pfnull.jpg\'">';


	thtml+='<div style="position:absolute;right:10px;top:10px;font-size:9pt;line-height:140%;padding-left:3px;padding-right:3px;font-weight:500;background:#3ad195;display:inline-block;border-radius:3px;text-align:center;padding-top:5px;"><font style="font-size:13pt;color:#fff"><i class="fa fa-map"></i></font><br><font style="font-size:8pt;color:#fff">루트맵</font></div>';

if(item.tripwith_txt!="")
	thtml+='<div style="position:absolute;left:10px;top:10px;font-size:9pt;line-height:190%;padding-left:6px;padding-right:6px;font-weight:500;background:#c0c0c0;display:inline-block;border-radius:3px;"><font style="font-size:9pt;color:#fff">'+item.tripwith_txt+'</font></div>';
if(item.pfimg)
{
	thtml+='<div style="position:absolute;right:10px;top:10px;">';
	thtml+='<img onerror="this.src=\'/img_v6/img_pfnull.gif\'" src="'+item.pfimg+'" style="width:35px;border-radius:100px;">';
	thtml+='</div>';
}
...
if(item.cost>0)
	thtml+='<div style="position:relative;height:42px;">';
else
	thtml+='<div style="position:relative;height:65px;">';

thtml+='<div style="position:absolute;top:5px;right:10px;padding-top:3px;font-size:12pt;font-weight:300;color:#696969;">'+item.term+'일간</div>';
thtml+='<div style="position:absolute;top:5px;left:10px;padding-top:3px;font-size:12pt;font-weight:300;color:#696969;">'+item.startdate_txt+' 출발</div>';
...
//	if(tw=='')	
//		thtml+='<div style="background:#f5f5f7;margin-top:5px;height:85px;border-bottom:1px solid #efefef;padding-bottom:5px;padding-top:5px;">';
//	else

	thtml+='<div style=";border-radius:5px;padding-top:5px;margin-right:10px;margin-left:20px;background:#f5f5f7;margin-top:10px;height:85px;padding-bottom:5px;position:relative;">';
	thtml+='<div style="padding-right:10px;text-align:right;font-size:8pt;font-weight:300;color:#696969;line-height:130%;">';
	thtml+='항공 <span style="display:inline-block;width:40px;font-size:10pt;text-align:right;">'+item.cost_air.toFixed(1)+'</span> 만원<br>';
	thtml+='숙박 <span style="display:inline-block;width:40px;font-size:10pt;text-align:right;">'+item.cost_slp.toFixed(1)+'</span>  만원<br>';
	thtml+='교통 <span style="display:inline-block;width:40px;font-size:10pt;text-align:right;">'+eval(item.cost_trs+item.cost_pass).toFixed(1)+'</span>  만원<br>';
	thtml+='투어 <span style="display:inline-block;width:40px;font-size:10pt;text-align:right;">'+item.cost_tour.toFixed(1)+'</span>  만원<br>';
	thtml+='<div style="display:inline-block;border-top:1px solid #c0c0c0;width:90px;"><span style="display:inline-block;width:40px;font-size:10pt;text-align:right;">'+item.cost.toFixed(1)+'</span>  만원</div>';
	thtml+='</div>';
	thtml+='<div style="position:absolute;font-size:10pt;font-weight:300;color:#696969;top:5px;left:10px;">예약비용</div>';
...
if(tw=='')
{
	thtml+='<div style="text-align:right;padding-top:3px;padding-right:7px;font-size:8pt;color:#c0c0c0">';
	thtml+=item.time_txt+' 수정';
	thtml+='</div>';
}
thtml+='</div>';
thtml+='</div></a>';
...
<!--
		...
		<div style="padding-left:20px;padding-right:20px"><a href="/template/index_ctry.asp"><div style="background:#3ad195;color:#fff;padding-top:15px;padding-bottom:15px;text-align:center;font-size:11pt;font-weight:600;margin-bottom:15px;"> <i class="fa fa-search" aria-hidden="true"></i> 최근 다녀온 32만개 계획 검색</div></a></div>
...
-->
       ...
       <section class="stu_swiper-section stu_recent-offer" style="padding-top:0px;margin-top:20px">


<div class="stu_inner_wrap">
               <div class="titArea" style="margin-top:20px">
                    <h3 class="stu_title" style="font-weight:300;">다녀온 여행자들의 플래너

</h3>
                </div>

                <div class="titArea" style="margin-bottom:0px">
                    <h3 class="stu_title" style="font-weight:300;"> </h3>
                </div>
<div  style="">

 
                        <a href="javascript:alert('다른 여행자들의 플래너 둘러보기는 앱에서만 할 수 있습니다. 앱스토어에서 스투비로 검색하세요.')"><div  style="width:20%;float:left;margin-bottom:0px;margin-top:0px;">
			...
			<div class="card" style="margin-left:10px;margin-right:10px;margin-top:0px;background:#fff;border-radius:10px;padding-bottom:0px;">
				<div style="position:relative;height:265px;width:100%;overflow:hidden;border-radius:10px;">
				 <img  src="http://stuweb.s3.amazonaws.com/0/0/1583393827449OWw1KpNkTz.jpg"  class="fw">
			...
			<div class="card" style="margin-left:10px;margin-right:10px;margin-top:0px;background:#fff;border-radius:10px;padding-bottom:0px;">
				<div style="position:relative;height:265px;width:100%;overflow:hidden;border-radius:10px;">
				 <img  src="http://stuweb.s3.amazonaws.com/0/0/1583070414731DMmh5aGw3b.jpg"  class="fw">



				<div style="position:absolute;top:10px;left:0px;color:#fff;padding-left:10px;padding-right:10px;padding-top:5px;padding-left:10px;line-height:120%;font-size:13pt;font-weight:300;">
					<b>서유럽</b><br>프랑스,스위스,영국,이탈리아..
	     			 </div>
				</div>
			...
			<div class="card" style="margin-left:10px;margin-right:10px;margin-top:0px;background:#fff;border-radius:10px;padding-bottom:0px;">
				<div style="position:relative;height:265px;width:100%;overflow:hidden;border-radius:10px;">
				 <img  src="http://stuweb.s3.amazonaws.com/0/0/1583393829077MVkWB3fbxr.jpg"  class="fw">



				<div style="position:absolute;top:10px;left:0px;color:#fff;padding-left:10px;padding-right:10px;padding-top:5px;padding-left:10px;line-height:120%;font-size:13pt;font-weight:300;">
					<b>동유럽</b><br>체코, 오스트리아, 헝가리..
	     			 </div>
				</div>
			...
			<div class="card" style="margin-left:10px;margin-right:10px;margin-top:0px;background:#fff;border-radius:10px;padding-bottom:0px;">
				<div style="position:relative;height:265px;width:100%;overflow:hidden;border-radius:10px;">
				 <img  src="http://d3b39vpyptsv01.cloudfront.net/0/0/1572507524886qqw0qpSy16.jpg"  class="fw">



				<div style="position:absolute;top:10px;left:0px;color:#fff;padding-left:10px;padding-right:10px;padding-top:5px;padding-left:10px;line-height:120%;font-size:13pt;font-weight:300;">
					<b>스페인+포르투갈</b><br>바르셀론,스페인남부,리스본,포르투..
	     			 </div>
				</div>
			...
			<div class="card" style="margin-left:10px;margin-right:10px;margin-top:0px;background:#fff;border-radius:10px;padding-bottom:0px;">
				<div style="position:relative;height:265px;width:100%;overflow:hidden;border-radius:10px;">
				 <img  src="http://d3b39vpyptsv01.cloudfront.net/0/0/1576040661397F0AFLiH3DC.JPG"  class="fw">



				<div style="position:absolute;top:10px;left:0px;color:#fff;padding-left:10px;padding-right:10px;padding-top:5px;padding-left:10px;line-height:120%;font-size:13pt;font-weight:300;">
					<b>그리스+터키</b><br>이스탄불,카파도키아, 산토리니..
	     			 </div>
				</div>
			...
			<div class="card" style="margin-left:10px;margin-right:10px;margin-top:0px;background:#fff;border-radius:10px;padding-bottom:0px;">
				<div style="position:relative;height:265px;width:100%;overflow:hidden;border-radius:10px;">
				 <img  src="http://stuweb.s3.amazonaws.com/0/0/1583393829829cLEhpJ5Wjp.jpg"  class="fw">



				<div style="position:absolute;top:10px;left:0px;color:#fff;padding-left:10px;padding-right:10px;padding-top:5px;padding-left:10px;line-height:120%;font-size:13pt;font-weight:300;">
					<b>크로아티아+슬로베니아</b><br>두브로브니크,플리트비체,블레드 ,스플리트..
	     			 </div>
				</div>
			...
			<div class="card" style="margin-left:10px;margin-right:10px;margin-top:0px;background:#fff;border-radius:10px;padding-bottom:0px;">
				<div style="position:relative;height:265px;width:100%;overflow:hidden;border-radius:10px;">
				 <img  src="http://stuweb.s3.amazonaws.com/0/0/1583070328027Kn2lU6XFCD.jpg"  class="fw">



				<div style="position:absolute;top:10px;left:0px;color:#fff;padding-left:10px;padding-right:10px;padding-top:5px;padding-left:10px;line-height:120%;font-size:13pt;font-weight:300;">
					<b>이탈리아</b><br>토스카나,시칠리아,돌로미티, 풀리아..
	     			 </div>
				</div>
			...
			<div class="card" style="margin-left:10px;margin-right:10px;margin-top:0px;background:#fff;border-radius:10px;padding-bottom:0px;">
				<div style="position:relative;height:265px;width:100%;overflow:hidden;border-radius:10px;">
				 <img  src="http://stuweb.s3.amazonaws.com/0/0/1583393830413f6YtNDxZrP_m.jpg"  class="fw">



				<div style="position:absolute;top:10px;left:0px;color:#fff;padding-left:10px;padding-right:10px;padding-top:5px;padding-left:10px;line-height:120%;font-size:13pt;font-weight:300;">
					<b>프랑스</b><br>프로방스,알자스,노르망디...
	     			 </div>
				</div>
			...
			<div class="card" style="margin-left:10px;margin-right:10px;margin-top:0px;background:#fff;border-radius:10px;padding-bottom:0px;">
				<div style="position:relative;height:265px;width:100%;overflow:hidden;border-radius:10px;">
				 <img  src="http://stuweb.s3.amazonaws.com/0/0/1583070326227WxGFuXxdX3.jpg"  class="fw">



				<div style="position:absolute;top:10px;left:0px;color:#fff;padding-left:10px;padding-right:10px;padding-top:5px;padding-left:10px;line-height:120%;font-size:13pt;font-weight:300;">
					<b>영국+아일랜드</b><br>스코틀랜드, 더블린, 북아일랜드, 웨일즈, 콘위..
	     			 </div>
				</div>
			...
			<div class="card" style="margin-left:10px;margin-right:10px;margin-top:0px;background:#fff;border-radius:10px;padding-bottom:0px;">
				<div style="position:relative;height:265px;width:100%;overflow:hidden;border-radius:10px;">
				 <img  src="http://d3b39vpyptsv01.cloudfront.net/0/0/1572507528895QeeKZ94w4s.jpg"  class="fw">



				<div style="position:absolute;top:10px;left:0px;color:#fff;padding-left:10px;padding-right:10px;padding-top:5px;padding-left:10px;line-height:120%;font-size:13pt;font-weight:300;">
					<b>아이슬란드</b><br>링로드일주, 스나이펠스네스..
	     			 </div>
				</div>
...
<div class="stu_inner_wrap">
                <div class="titArea">
                    <h3 class="stu_title" style="font-weight:300;">각 지역 전문가의 루트 <font style="font-size:10pt;font-weight:400">Multiday 상품</font></h3>
                </div>
<div  style="">

                        <a href="/market/group.asp?serial=338"><div  style="width:20%;float:left;margin-bottom:0px;margin-top:0px;">
			
			<div class="card" style="margin-left:10px;margin-right:10px;margin-top:0px;background:#fff;border-radius:10px;padding-bottom:0px;">
				<div style="position:relative;height:205px;width:100%;overflow:hidden;border-radius:0px;">
				 <img  src="http://stuweb.s3.amazonaws.com/0/0/1583070326227WxGFuXxdX3.jpg"  class="fw">



				<div style="position:absolute;top:10px;left:0px;color:#fff;padding-left:10px;padding-right:10px;padding-top:5px;padding-left:10px;line-height:120%;font-size:13pt;font-weight:300;">
					<b>스코틀랜드 미니팩</b><br>하이랜드/스카이섬/위스키<br>
	     			 </div>
				</div>
                        ...
                        <a href="/market/group.asp?serial=455"><div  style="width:20%;float:left;margin-bottom:0px;margin-top:0px;">
			...
			<div class="card" style="margin-left:10px;margin-right:10px;margin-top:0px;background:#fff;border-radius:10px;padding-bottom:0px;">
				...
				<div style="position:absolute;top:10px;left:0px;color:#fff;padding-left:10px;padding-right:10px;padding-top:5px;padding-left:10px;line-height:120%;font-size:13pt;font-weight:300;">
					<b>시칠리아 미니팩</b><br>시칠리아/몰타
                        ...
                        <a href="/market/group.asp?serial=451"><div  style="width:20%;float:left;margin-bottom:0px;margin-top:0px;">
			...
			<div class="card" style="margin-left:10px;margin-right:10px;margin-top:0px;background:#fff;border-radius:10px;padding-bottom:0px;">
				...
				<div style="position:absolute;top:10px;left:0px;color:#fff;padding-left:10px;padding-right:10px;padding-top:5px;padding-left:10px;line-height:120%;font-size:13pt;font-weight:300;">
					<b>스페인 남부+ 미니팩</b><br>남부/포르투갈/모로코
                        ...
                        <a href="/market/group.asp?serial=449"><div  style="width:20%;float:left;margin-bottom:0px;margin-top:0px;">
			
			<div class="card" style="margin-left:10px;margin-right:10px;margin-top:0px;background:#fff;border-radius:10px;padding-bottom:0px;">
				<div style="position:relative;height:205px;width:100%;overflow:hidden;border-radius:0px;">
				 <img  src="http://d3b39vpyptsv01.cloudfront.net/0/0/1576040665858UeYCKoxi9o.JPG"  class="fw">



				<div style="position:absolute;top:10px;left:0px;color:#fff;padding-left:10px;padding-right:10px;padding-top:5px;padding-left:10px;line-height:120%;font-size:13pt;font-weight:300;">
					<b>아일랜드 미니팩</b><br>아일랜드/북아일랜드
	     			 </div>
				</div>
                        ...
                        <a href="/market/group.asp?serial=403"><div  style="width:20%;float:left;margin-bottom:0px;margin-top:0px;">
			...
			<div class="card" style="margin-left:10px;margin-right:10px;margin-top:0px;background:#fff;border-radius:10px;padding-bottom:0px;">
				...
				<div style="position:absolute;top:10px;left:0px;color:#fff;padding-left:10px;padding-right:10px;padding-top:5px;padding-left:10px;line-height:120%;font-size:13pt;font-weight:300;">
					<b>터키 미니팩</b><br>벌룬투어.그린투어.레드투어.페티예패러글라이딩.이스탄불가이드.터키일주
	     			 </div>
				</div>
                        ...
                        <a href="/market/group.asp?serial=454"><div  style="width:20%;float:left;margin-bottom:0px;margin-top:0px;">
			...
			<div class="card" style="margin-left:10px;margin-right:10px;margin-top:0px;background:#fff;border-radius:10px;padding-bottom:0px;">
				...
				<div style="position:absolute;top:10px;left:0px;color:#fff;padding-left:10px;padding-right:10px;padding-top:5px;padding-left:10px;line-height:120%;font-size:13pt;font-weight:300;">
					<b>이탈리아 남부 미니팩</b><br>아말피/풀리아 지역
                        ...
                        <a href="/market/group.asp?serial=341"><div  style="width:20%;float:left;margin-bottom:0px;margin-top:0px;">
			
			<div class="card" style="margin-left:10px;margin-right:10px;margin-top:0px;background:#fff;border-radius:10px;padding-bottom:0px;">
				<div style="position:relative;height:205px;width:100%;overflow:hidden;border-radius:0px;">
				 <img  src="http://d3b39vpyptsv01.cloudfront.net/0/0/1576040664317UklvFY678H.JPG"  class="fw">
				...
				<div style="position:absolute;top:10px;left:0px;color:#fff;padding-left:10px;padding-right:10px;padding-top:5px;padding-left:10px;line-height:120%;font-size:13pt;font-weight:300;">
					<b>그리스 미니팩</b><br>내륙/섬
                        ...
                        <a href="/market/group.asp?serial=430"><div  style="width:20%;float:left;margin-bottom:0px;margin-top:0px;">
			
			<div class="card" style="margin-left:10px;margin-right:10px;margin-top:0px;background:#fff;border-radius:10px;padding-bottom:0px;">
				<div style="position:relative;height:205px;width:100%;overflow:hidden;border-radius:0px;">
				 <img  src="http://stuweb.s3.amazonaws.com/0/0/1583070328683Bu56bbd4IV.jpg"  class="fw">



				<div style="position:absolute;top:10px;left:0px;color:#fff;padding-left:10px;padding-right:10px;padding-top:5px;padding-left:10px;line-height:120%;font-size:13pt;font-weight:300;">
					<b>웨일즈 미니팩</b><br>웨일즈/스노도니아
	     			 </div>
				</div>
                        ...
                        <a href="/market/group.asp?serial=230"><div  style="width:20%;float:left;margin-bottom:0px;margin-top:0px;">
			...
			<div class="card" style="margin-left:10px;margin-right:10px;margin-top:0px;background:#fff;border-radius:10px;padding-bottom:0px;">
				...
				<div style="position:absolute;top:10px;left:0px;color:#fff;padding-left:10px;padding-right:10px;padding-top:5px;padding-left:10px;line-height:120%;font-size:13pt;font-weight:300;">
					<b>아이슬란드 미니팩</b><br>남부/일주/트레킹
                        ...
                        <a href="/market/group.asp?serial=444"><div  style="width:20%;float:left;margin-bottom:0px;margin-top:0px;">
			
			<div class="card" style="margin-left:10px;margin-right:10px;margin-top:0px;background:#fff;border-radius:10px;padding-bottom:0px;">
				<div style="position:relative;height:205px;width:100%;overflow:hidden;border-radius:0px;">
				 <img  src="http://stuweb.s3.amazonaws.com/0/0/15830708176279IqOLIcjfj.jpg"  class="fw">



				<div style="position:absolute;top:10px;left:0px;color:#fff;padding-left:10px;padding-right:10px;padding-top:5px;padding-left:10px;line-height:120%;font-size:13pt;font-weight:300;">
					<b>롸이가베구르 트레킹</b><br>오직 여름만 열리는 세계적인 트레킹코스
	     			 </div>
				</div>
...
<script>
var tour_thema_Swiper;

var tour_thema_Swiper1;
var tour_thema_Swiper2;
var tour_thema_Swiper3;
var tour_thema_Swiper4;
var tour_thema_Swiper5;
var tour_thema_Swiper6;
var tour_thema_Swiper7;
var tour_thema_Swiper8;
...
tour_thema_Swiper = new Swiper($("#recomm_tour_themas_container"), {
            slidesPerView:'auto',
            freeMode:false,
            direction:'horizontal',
            scrollbar: {
                el:$("#recomm_tour_themas_container").children('.swiper-scrollbar'),
                hide:true,
            },
            navigation: {
                nextEl: $("#recomm_tour_themas_container").siblings('.swiper-button-next'),
                prevEl: $("#recomm_tour_themas_container").siblings('.swiper-button-prev'),
            },
            breakpoints: {
                619: {
                    freeMode:true,
...
function  func_premium2(msg,tid)
{
	if(tid=="")
	{
		$("#premium2_modal_link").hide();
		$("#premium2_modal_link").attr("href","#");	
	}
	else
	{
		$("#premium2_modal_link").attr("href","javascript:deletePlan('"+tid+"')");	
		$("#premium2_modal_link").show();
	}
...
<div id="alert_modal" style="display:none; position:fixed; top:0; left:0; right:0; bottom:0; background:rgba(0,0,0,.15); z-index:99999;">
            <div style="position:relative; top:30%; left:50%; transform:translate(-50%, -50%); width:320px; border-radius:2px; box-shadow:0 0 0 1px rgba(0,0,0,.1), 0 2px 8px 0 rgba(0,0,0,.25); background:#fff;">
                ...
                <div style="padding:0 24px 20px; text-align:center;">
                    <a href="javascript:closeAlertModal()"  style="display:inline-block;padding-top:2px;padding-bottom:2px;padding-left:10px;padding-right:10px;border-radius:3px;background:#8f8f8f">
...
<div id="premium2_modal" style="display:none; position:fixed; top:0; left:0; right:0; bottom:0; background:rgba(0,0,0,.15); z-index:99999;">
            <div style="position:relative; top:30%; left:50%; transform:translate(-50%, -50%); width:320px; border-radius:2px; box-shadow:0 0 0 1px rgba(0,0,0,.1), 0 2px 8px 0 rgba(0,0,0,.25); background:#fff;">
                <div style="position:relative; height:42px; padding:0 18px; background:#f5f5f7; font-size:15px; font-weight:normal; line-height:42px; color:#4a4a4a;">안내
                    <a href="javascript:closepremium2Modal()" class="" style="position:absolute; top:50%; right:20px; transform:translateY(-50%); width:22px; height:22px; background-image:url(https://d3b39vpyptsv01.cloudfront.net/0/0/1548911555427eWBbProQMk.png); background-size:cover;"></a>
                </div>
                ...
                <div style="padding:0 24px 20px; text-align:center;">
                    ...
                    <a href="/planner/premium.asp" class="btn-u btn-u-xs" style="border-radius:3px; background:#8f8f8f;display:block;">
...
<div id="div_route_map" style="display:none;z-index:999;position:fixed;left:0px;top:0px;width:100%;height:100%;background:#fff">
	...
	<div style="position:relative;float:left;width:30%;height:100%;background:#fff">
		<div id="" style="position:relative;width:100%;height:5%;"><a href="#" id="route_copy_button" style="padding-top:10px;padding-bottom:10px;font-size:12pt;color:#fff;background:#3ad195;text-align:center;font-weight:600;display:block">이 루트로 플래너 시작&nbsp; <i class="fa fa-chevron-right"></i></a></div>
		<div id="route_citylist" style="position: relative;height:95%;padding-left: 20px;font-size: 13pt;padding-top: 20px;" ></div>
	</div>
